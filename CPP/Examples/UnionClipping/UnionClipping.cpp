...
void DoDiamonds()
{
  ...
  for (int i = 0; i < h / size; i += 2)
  {
    ...
    shape = TranslatePath(shape, static_cast<Int128>(-w / size) * size, size*2);
  }
...
void DoSquares()
{
  ...
  for (int i = 0; i < h / size; ++i)
  {
    ...
    shape = TranslatePath(shape, static_cast<Int128>(-w / size) * size, size);
  }
...
void DoTriangles()
{
  ...
  for (int i = 0; i < h / size / 2; ++i)
  {
    ...
    tri1 = TranslatePath(tri1, static_cast<Int128>(-w / size) * size, size * 2);
    tri2 = TranslatePath(tri2, static_cast<Int128>(-w / size) * size, size * 2);
  }
