...
namespace Clipper2Lib
{
  ...
  static const UInt128 UINT128_MAX =UInt128(Int128(-1L));
  static const Int128 INT128_MAX = UINT128_MAX >> 1;
  static const Int128 INT128_MIN = -INT128_MAX - 1;

  static const Int128 MAX_COORD = INT128_MAX >> 2;
  static const Int128 MIN_COORD = -MAX_COORD;
  static const Int128 INVALID = INT128_MAX;
  ...
  struct Point {
    ...
    Point operator * (const double scale) const
    {
      ...
      friend std::ostream& operator<<(std::ostream& os, [[maybe_unused]]const Point& point)
    {//TODO
//      constexpr const Int128 bottom_mask = (Int128{1} << 64) - 1;
//      constexpr const Int128 top_mask = ~bottom_mask;
